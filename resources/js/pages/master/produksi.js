export default {
    async initIndex() {
        console.log("Halaman Master->Produksi Index berhasil dimuat!");
    ...
    initShow() {
        console.log("Halaman Master->Produksi Show berhasil dimuat!");
    },
    initCreate() {
        console.log("Halaman Master->Produksi Create berhasil dimuat!");
    },
    initEdit() {
        console.log("Halaman Master->Produksi Edit berhasil dimuat!");
    },
};
