                ...
                @else
                    @foreach ($activities as $activity)
                        <tr>
                            ...
                            <!-- Data Baru (update dari data lama) -->
                            <td>
                            ...
                            <!-- Data Baru Mutasi (data baru yang dihasilkan, yaitu changed_data) -->
                            <td>
                                @if (isset($activity->properties['changed_data']) && is_array($activity->properties['changed_data']))
                                    <table class="table table-sm table-borderless mb-0">
                                        <thead>
                                            <tr>
                                                <th>Field</th>
                                        ...
                                        <tbody>
                                            @foreach ($activity->properties['changed_data'] as $key => $value)
                                                <tr>
                                                    <td>{{ $key }}</td>
                                                    <td>
                                                        @if (is_array($value))
