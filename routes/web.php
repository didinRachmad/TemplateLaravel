...
Route::prefix('master_produksi')
    ->middleware('auth')
    ->group(function () {
        Route::get('/', [ProduksiController::class, 'index'])
            ->name('master_produksi.index')
            ->middleware('menu.permission:index');
        Route::get('/create', [ProduksiController::class, 'create'])
            ->name('master_produksi.create')
            ->middleware('menu.permission:create');
        Route::post('/store', [ProduksiController::class, 'store'])
            ->name('master_produksi.store')
            ->middleware('menu.permission:store');
        Route::get('/edit/{produksi}', [ProduksiController::class, 'edit'])
            ->name('master_produksi.edit')
            ->middleware('menu.permission:edit');
        Route::put('/update/{produksi}', [ProduksiController::class, 'update'])
            ->name('master_produksi.update')
            ->middleware('menu.permission:update');
        Route::delete('/destroy/{produksi}', [ProduksiController::class, 'destroy'])
            ->name('master_produksi.destroy')
            ->middleware('menu.permission:destroy');
    });
...
Route::prefix('items')
    ...
    ->group(function () {
        ...
        Route::get('/edit/{item}', [ItemController::class, 'edit'])
            ->name('items.edit')
            ->middleware('menu.permission:edit');
        Route::get('/checkQR/{id}', [ItemController::class, 'checkQR'])
            ->name('items.checkQR')
            ->middleware('menu.permission:show');
        Route::put('/update/{item}', [ItemController::class, 'update'])
            ->name('items.update')
            ->middleware('menu.permission:update');
        Route::post('/approve/{item}', [ItemController::class, 'approve'])
            ->name('items.approve')
            ->middleware('menu.permission:approve');
        Route::post('/items/{item}/revise', [ItemController::class, 'revise'])
            ->name('items.revise')
            ->middleware('menu.permission:approve');
        Route::post('/items/{item}/reject', [ItemController::class, 'reject'])
            ->name('items.reject')
            ->middleware('menu.permission:approve');
        Route::get('items/{item}/print', [ItemController::class, 'printQR'])
            ->name('items.printQR')
            ->middleware('menu.permission:print');
        Route::delete('/destroy/{item}', [ItemController::class, 'destroy'])
            ->name('items.destroy')
            ->middleware('menu.permission:destroy');
    });
...
Route::prefix('mutasi')
    ...
    ->group(function () {
        Route::get('/', [MutasiController::class, 'index'])
            ->name('mutasi.index')
            ->middleware('menu.permission:index');
        Route::get('/show/{item}', [MutasiController::class, 'show'])
            ->name('mutasi.show')
            ->middleware('menu.permission:show');
        Route::get('/edit/{item}', [MutasiController::class, 'edit'])
            ->name('mutasi.edit')
            ->middleware('menu.permission:edit');
        Route::put('/update/{item}', [MutasiController::class, 'update'])
            ->name('mutasi.update')
            ->middleware('menu.permission:update');
    });

Route::get('/activity-logs/{item}', [ActivityLogController::class, 'showActivity'])->name('activity_logs.show');
